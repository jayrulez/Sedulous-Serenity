...
class FrameworkNavigationApp : Application
{
	...
	protected override void OnInput()
	{
		...
		if (mNavDemo != null)
		{
			...
			bool uiHovered = hitElement != null && hitElement != mUISubsystem.GUIContext.RootElement;
