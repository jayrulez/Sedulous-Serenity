...
class RuntimeEntityData
{
	...
	public Sedulous.Core.Mathematics.Vector3 Position;
	public Sedulous.Core.Mathematics.Vector3 Rotation;
	public Sedulous.Core.Mathematics.Vector3 Scale = .(1, 1, 1);
