 ...
 */
//public typealias SDL_BlendMode = uint32;
public enum SDL_BlendMode : uint32
{
	...
	SDL_BLENDMODE_BLEND_PREMULTIPLIED   = 0x00000010, /**< pre-multiplied alpha blending: dstRGBA = srcRGBA + (dstRGBA * (1-srcA)) */
	SDL_BLENDMODE_ADD                   = 0x00000002, /**< additive blending: dstRGB = (srcRGB * srcA) + dstRGB, dstA = dstA */
	SDL_BLENDMODE_ADD_PREMULTIPLIED     = 0x00000020, /**< pre-multiplied additive blending: dstRGB = srcRGB + dstRGB, dstA = dstA */
	SDL_BLENDMODE_MOD                   = 0x00000004, /**< color modulate: dstRGB = srcRGB * dstRGB, dstA = dstA */
	SDL_BLENDMODE_MUL                   = 0x00000008, /**< color multiply: dstRGB = (srcRGB * dstRGB) + (dstRGB * (1-srcA)), dstA = dstA */
