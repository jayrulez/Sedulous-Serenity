...
{
	public static SDL_Keycode SDL_SCANCODE_TO_KEYCODE(SDL_Keycode X)
	{
...
public enum SDL_Keymod : uint16 //public typealias SDL_Keymod = uint16;
{
	...
	SDL_KMOD_LEVEL5 = 0x0004, /**< the Level 5 Shift key is down. */
	...
	SDL_KMOD_SCROLL = 0x8000, /**< the Scroll Lock key is down. */
