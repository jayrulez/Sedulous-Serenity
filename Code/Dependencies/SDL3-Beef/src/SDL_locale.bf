 ...
 */
[CRepr] public struct SDL_Locale
{
    public char8* language;  /**< A language name, like "en" for English. */
    public char8* country;  /**< A country, like "US" for America. Can be NULL. */
}
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern SDL_Locale** SDL_GetPreferredLocales(int32* count);
