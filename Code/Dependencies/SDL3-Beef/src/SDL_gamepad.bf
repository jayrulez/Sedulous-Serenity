...
[CLink] public static extern SDL_PropertiesID SDL_GetGamepadProperties(SDL_Gamepad *gamepad);
	...
	public const char8* SDL_PROP_GAMEPAD_CAP_PLAYER_LED_BOOLEAN     = SDL_PROP_JOYSTICK_CAP_PLAYER_LED_BOOLEAN;
	public const char8* SDL_PROP_GAMEPAD_CAP_RUMBLE_BOOLEAN         = SDL_PROP_JOYSTICK_CAP_RUMBLE_BOOLEAN;
	public const char8* SDL_PROP_GAMEPAD_CAP_TRIGGER_RUMBLE_BOOLEAN = SDL_PROP_JOYSTICK_CAP_TRIGGER_RUMBLE_BOOLEAN;
