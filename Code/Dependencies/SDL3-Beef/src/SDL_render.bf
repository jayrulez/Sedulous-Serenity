 ...
 *
 * \param renderer the rendering context.
 * \param w an int32 filled with the logical presentation width.
 * \param h an int32 filled with the logical presentation height.
 ...
 * \param num_indices number of indices.
 * \param size_indices index size: 1 (byte), 2 (short), 4 (int32).
 * \returns true on success or false on failure; call SDL_GetError() for more
 *          information.
 *
 * \threadsafety This function should only be called on the main thread.
 ...
 *
 * \param renderer the renderer to toggle.
 * \param vsync an int32 filled with the current vertical refresh sync interval.
