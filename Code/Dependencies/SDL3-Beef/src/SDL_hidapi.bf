 ...
 */
	[CLink] public static extern SDL_hid_device_info* SDL_hid_enumerate(uint16 vendor_id, uint16 product_id);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern SDL_hid_device* SDL_hid_open(uint16 vendor_id, uint16 product_id, char16* serial_number);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_write(SDL_hid_device* dev, c_uchar* data, uint length);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_read_timeout(SDL_hid_device* dev, c_uchar* data, uint length, int32 milliseconds);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_read(SDL_hid_device* dev, c_uchar* data, uint length);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_send_feature_report(SDL_hid_device* dev, c_uchar* data, uint length);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_get_feature_report(SDL_hid_device* dev, c_uchar* data, uint length);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_get_input_report(SDL_hid_device* dev, c_uchar* data, uint length);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_get_manufacturer_string(SDL_hid_device* dev, char16* string, uint maxlen);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_get_product_string(SDL_hid_device* dev, char16* string, uint maxlen);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_get_serial_number_string(SDL_hid_device* dev, char16* string, uint maxlen);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_get_indexed_string(SDL_hid_device* dev, int32 string_index, char16* string, uint maxlen);
 ...
 * \since This function is available since SDL 3.2.0.
 */
	[CLink] public static extern int32 SDL_hid_get_report_descriptor(SDL_hid_device* dev, c_uchar* buf, uint buf_size);
