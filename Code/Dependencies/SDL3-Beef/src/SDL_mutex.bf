 ...
 * \sa SDL_UnlockMutex
 */
	[CLink] public static extern bool SDL_TryLockMutex(SDL_Mutex* mutex);
 ...
 * \sa SDL_UnlockRWLock
 */
	[CLink] public static extern bool SDL_TryLockRWLockForReading(SDL_RWLock* rwlock);
 ...
 * \sa SDL_UnlockRWLock
 */
	[CLink] public static extern bool SDL_TryLockRWLockForWriting(SDL_RWLock* rwlock);
