 ...
 */
//public typealias SDL_MouseButtonFlags = uint32;
...
{
	public static uint32 SDL_BUTTON_MASK(SDL_MouseButtonFlags X)  => (1u << (((uint32)X) - 1));
	public const uint32 SDL_BUTTON_LMASK    = SDL_BUTTON_MASK(.SDL_BUTTON_LEFT);
	public const uint32 SDL_BUTTON_MMASK    = SDL_BUTTON_MASK(.SDL_BUTTON_MIDDLE);
	public const uint32 SDL_BUTTON_RMASK    = SDL_BUTTON_MASK(.SDL_BUTTON_RIGHT);
	public const uint32 SDL_BUTTON_X1MASK   = SDL_BUTTON_MASK(.SDL_BUTTON_X1);
	public const uint32 SDL_BUTTON_X2MASK   = SDL_BUTTON_MASK(.SDL_BUTTON_X2);
