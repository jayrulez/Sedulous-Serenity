...
abstract class InputBinding : ISerializable
{
	...
	public abstract int32 SerializationVersion { get; }
	public abstract SerializationResult Serialize(Serializer serializer);
}
