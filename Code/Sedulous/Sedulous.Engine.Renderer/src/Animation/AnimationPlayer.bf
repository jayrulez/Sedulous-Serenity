...
class AnimationPlayer
{
	...
	{
		mSkeleton = skeleton;
		BoneMatrices = new Matrix[Sedulous.Engine.Renderer.Skeleton.MAX_BONES];
	...
	public void UpdateBoneMatrices()
	{
		...
		mSkeleton.CopySkinningMatrices(&BoneMatrices[0], Sedulous.Engine.Renderer.Skeleton.MAX_BONES);
	}
