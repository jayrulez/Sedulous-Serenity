...
/// </summary>
struct Size3F : IEquatable<Size3F>, IInterpolatable<Size3F>, IEquatable, IHashable
{
    /// <summary>
    ...
    public this(float width, float height, float depth)
    {
        this.Width = width;
        this.Height = height;
        this.Depth = depth;
    ...
    /// <param name="multiplier">The multiplier to apply to the size.</param>
    /// <returns>A <see cref="Size3F"/> which is the result of the muliplication.</returns>
    public static Size3F operator *(Size3F size, float multiplier)
    {
        Size3F result;
    ...
    /// <param name="divisor">The divisor to apply to the size.</param>
    /// <returns>A <see cref="Size3F"/> which is the result of the muliplication.</returns>
    public static Size3F operator /(Size3F size, float divisor)
    {
        Size3F result;
    ...
    public Size3F Interpolate(Size3F target, float t)
    {
        Size3F result;
