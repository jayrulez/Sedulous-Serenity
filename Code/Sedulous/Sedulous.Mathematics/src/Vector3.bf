...
struct Vector3 : IEquatable<Vector3>, IInterpolatable<Vector3>, IEquatable, IHashable
{
	...
	public static void Dot(in Vector3 vector1, in Vector3 vector2, out float result)
	{
	...
	/// <param name="factor">The scaling factor by which to multiply the vector.</param>
	/// <param name="result">The resulting <see cref="Vector3"/>.</param>
	public static void Multiply(in Vector3 vector, float factor, out Vector3 result)
	{
	    result.X = vector.X * factor;
	    result.Y = vector.Y * factor;
	    result.Z = vector.Z * factor;
	...
	/// <param name="factor">The scaling factor by which to divide the vector.</param>
	/// <param name="result">The resulting <see cref="Vector3"/>.</param>
	public static void Divide(in Vector3 vector, float factor, out Vector3 result)
	{
	    result.X = vector.X / factor;
	    result.Y = vector.Y / factor;
	    result.Z = vector.Z / factor;
	...
	public static void Transform(in Vector3 vector, in Quaternion quaternion, out Vector3 result)
	{
	    var x2 = quaternion.X + quaternion.X;
	    var y2 = quaternion.Y + quaternion.Y;
	    var z2 = quaternion.Z + quaternion.Z;
	...
	/// <param name="matrix">The matrix by which to transform the vector.</param>
	/// <param name="result">The transformed <see cref="Vector3"/>.</param>
	public static void Transform(in Vector3 vector, in Matrix matrix, out Vector3 result)
	{
	    Vector3 temp;
	...
	/// <param name="matrix">The matrix by which to transform the vector.</param>
	/// <param name="result">The transformed <see cref="Vector3"/>.</param>
	public static void TransformNormal(in Vector3 vector, in Matrix matrix, out Vector3 result)
	{
	    Vector3 temp;
	...
	public static void Negate(in Vector3 vector, out Vector3 result)
	{
	    result.X = -vector.X;
	    result.Y = -vector.Y;
	    result.Z = -vector.Z;
	...
	public static void Clamp(in Vector3 vector, in Vector3 min, in Vector3 max, out Vector3 result)
	{
	    result.X = vector.X < min.X ? min.X : vector.X > max.X ? max.X : vector.X;
	    result.Y = vector.Y < min.Y ? min.Y : vector.Y > max.Y ? max.Y : vector.Y;
	    result.Z = vector.Z < min.Z ? min.Z : vector.Z > max.Z ? max.Z : vector.Z;
	...
	public static void Min(in Vector3 vector1, in Vector3 vector2, out Vector3 result)
	{
	    result.X = vector1.X < vector2.X ? vector1.X : vector2.X;
	    result.Y = vector1.Y < vector2.Y ? vector1.Y : vector2.Y;
	    result.Z = vector1.Z < vector2.Z ? vector1.Z : vector2.Z;
	...
	public static void Max(in Vector3 vector1, in Vector3 vector2, out Vector3 result)
	{
	    result.X = vector1.X < vector2.X ? vector2.X : vector1.X;
	    result.Y = vector1.Y < vector2.Y ? vector2.Y : vector1.Y;
	    result.Z = vector1.Z < vector2.Z ? vector2.Z : vector1.Z;
	...
	public static void Lerp(in Vector3 vector1, in Vector3 vector2, float amount, out Vector3 result)
	{
	    result.X = vector1.X + (vector2.X - vector1.X) * amount;
	    result.Y = vector1.Y + (vector2.Y - vector1.Y) * amount;
	    result.Z = vector1.Z + (vector2.Z - vector1.Z) * amount;            
	...
	public static void Hermite(in Vector3 vector1, in Vector3 tangent1, in Vector3 vector2, in Vector3 tangent2, float amount, out Vector3 result)
	{
	    var t2 = amount * amount;
	    var t3 = t2 * amount;
	...
	/// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
	/// <param name="result">The interpolated <see cref="Vector3"/>.</param>
	public static void SmoothStep(in Vector3 vector1, in Vector3 vector2, float amount, out Vector3 result)
	{
		var amount;
	    amount = amount > 1 ? 1 : amount < 0 ? 0 : amount;
	    amount = amount * amount * (3.0f - 2.0f * amount);
	...
	/// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
	/// <param name="result">The interpolated <see cref="Vector3"/>.</param>
	public static void CatmullRom(in Vector3 vector1, in Vector3 vector2, in Vector3 vector3, in Vector3 vector4, float amount, out Vector3 result)
	{
	    var t2 = amount * amount;
	    var t3 = t2 * amount;
	...
	public static void Distance(in Vector3 vector1, in Vector3 vector2, out float result)
	{
	    var dx = vector2.X - vector1.X;
	    var dy = vector2.Y - vector1.Y;
	    var dz = vector2.Z - vector1.Z;
	...
	public static void DistanceSquared(in Vector3 vector1, in Vector3 vector2, out float result)
	{
	    var dx = vector2.X - vector1.X;
	    var dy = vector2.Y - vector1.Y;
	    var dz = vector2.Z - vector1.Z;
	...
	public static void Barycentric(in Vector3 v1, in Vector3 v2, in Vector3 v3, float b2, float b3, out Vector3 result)
	{
	    var b1 = (1 - b2 - b3);
