...
/// </summary>
struct Point2 : IEquatable<Point2>, IInterpolatable<Point2>, IEquatable, IHashable
{
    /// <summary>
    ...
    public static Point2F operator *(Point2 point, float multiplier)
    {
        Point2 result;
    ...
    /// <param name="divisor">The divisor to apply to the size.</param>
    /// <returns>A <see cref="Point2F"/> which is the result of the muliplication.</returns>
    public static Point2F operator /(Point2 point, float divisor)
    {
        Point2 result;
    ...
    public static void Transform(in Point2 point, in Quaternion quaternion, out Point2 result)
    {
        var x2 = quaternion.X + quaternion.X;
        var y2 = quaternion.Y + quaternion.Y;
        var z2 = quaternion.Z + quaternion.Z;
    ...
    /// <param name="matrix">The matrix by which to transform the point.</param>
    /// <param name="result">The transformed <see cref="Point2"/>.</param>
    public static void Transform(in Point2 point, in Matrix matrix, out Point2 result)
    {
        Point2 temp;
    ...
    public Point2 Interpolate(Point2 target, float t)
    {
        Point2 result;
