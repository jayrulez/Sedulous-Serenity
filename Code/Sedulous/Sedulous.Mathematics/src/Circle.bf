...
/// </summary>
struct Circle : IEquatable<Circle>, IInterpolatable<Circle>, IEquatable, IHashable
{
    /// <summary>
    ...
    public this(int32 x, int32 y, int32 radius)
    {
        this.X = x;
        this.Y = y;
        this.Radius = radius;
    ...
    /// <param name="radius">The circle's radius.</param>
    public this(Point2 position, int32 radius)
    ...
    public Circle Interpolate(Circle target, float t)
    {
        Circle result;
