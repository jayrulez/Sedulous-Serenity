...
struct Vector4 : IEquatable<Vector4>, IInterpolatable<Vector4>, IEquatable, IHashable
{
    ...
    /// <param name="z">The vector's z component.</param>
    /// <param name="w">The vector's w component.</param>
    public this(Vector2 vector, float z, float w)
    {
        this.X = vector.X;
        this.Y = vector.Y;
        this.Z = z;
    ...
    /// <param name="w">The vector's w component.</param>
    public this(Vector3 vector, float w)
    {
        this.X = vector.X;
        this.Y = vector.Y;
        this.Z = vector.Z;
	...
	/// <param name="factor">The scaling factor by which to multiply the vector.</param>
	/// <param name="result">The resulting <see cref="Vector4"/>.</param>
	public static void Multiply(in Vector4 vector, float factor, out Vector4 result)
	{
	    result.X = vector.X * factor;
	    result.Y = vector.Y * factor;
	    result.Z = vector.Z * factor;
	...
	/// <param name="factor">The scaling factor by which to divide the vector.</param>
	/// <param name="result">The resulting <see cref="Vector4"/>.</param>
	public static void Divide(in Vector4 vector, float factor, out Vector4 result)
	{
	    result.X = vector.X / factor;
	    result.Y = vector.Y / factor;
	    result.Z = vector.Z / factor;
	...
	public static void Transform(in Vector2 vector, in Quaternion quaternion, out Vector4 result)
	{
	    var x2 = quaternion.X + quaternion.X;
	    var y2 = quaternion.Y + quaternion.Y;
	    var z2 = quaternion.Z + quaternion.Z;
	...
	/// <param name="quaternion">The quaternion by which to transform the vector.</param>
	/// <param name="result">The transformed <see cref="Vector4"/>.</param>
	public static void Transform(in Vector3 vector, in Quaternion quaternion, out Vector4 result)
	{
	    var x2 = quaternion.X + quaternion.X;
	    var y2 = quaternion.Y + quaternion.Y;
	    var z2 = quaternion.Z + quaternion.Z;
	...
	/// <param name="quaternion">The quaternion by which to transform the vector.</param>
	/// <param name="result">The transformed <see cref="Vector4"/>.</param>
	public static void Transform(in Vector4 vector, in Quaternion quaternion, out Vector4 result)
	{
	    var x2 = quaternion.X + quaternion.X;
	    var y2 = quaternion.Y + quaternion.Y;
	    var z2 = quaternion.Z + quaternion.Z;
	...
	/// <param name="matrix">The matrix by which to transform the vector.</param>
	/// <param name="result">The transformed <see cref="Vector4"/>.</param>
	public static void Transform(in Vector2 vector, in Matrix matrix, out Vector4 result)
	{
	    Vector4 temp;
	...
	/// <param name="matrix">The matrix by which to transform the vector.</param>
	/// <param name="result">The transformed <see cref="Vector4"/>.</param>
	public static void Transform(in Vector3 vector, in Matrix matrix, out Vector4 result)
	{
	    Vector4 temp;
	...
	public static void Negate(in Vector4 vector, out Vector4 result)
	{
	    result.X = -vector.X;
	    result.Y = -vector.Y;
	    result.Z = -vector.Z;
	...
	public static void Clamp(in Vector4 vector, in Vector4 min, in Vector4 max, out Vector4 result)
	{
	    result.X = vector.X < min.X ? min.X : vector.X > max.X ? max.X : vector.X;
	    result.Y = vector.Y < min.Y ? min.Y : vector.Y > max.Y ? max.Y : vector.Y;
	    result.Z = vector.Z < min.Z ? min.Z : vector.Z > max.Z ? max.Z : vector.Z;
	...
	public static void Min(in Vector4 vector1, in Vector4 vector2, out Vector4 result)
	{
	    result.X = vector1.X < vector2.X ? vector1.X : vector2.X;
	    result.Y = vector1.Y < vector2.Y ? vector1.Y : vector2.Y;
	    result.Z = vector1.Z < vector2.Z ? vector1.Z : vector2.Z;
	...
	public static void Max(in Vector4 vector1, in Vector4 vector2, out Vector4 result)
	{
	    result.X = vector1.X < vector2.X ? vector2.X : vector1.X;
	    result.Y = vector1.Y < vector2.Y ? vector2.Y : vector1.Y;
	    result.Z = vector1.Z < vector2.Z ? vector2.Z : vector1.Z;
	...
	public static void Reflect(in Vector4 vector, in Vector4 normal, out Vector4 result)
	{
	    var dot = vector.X * normal.X + vector.Y * normal.Y + vector.Z * normal.Z + vector.W * normal.W;
	...
	public static Vector4 Lerp(Vector4 vector1, Vector4 vector2, float amount)
	{
	    Vector4 result;
	...
	public static void Lerp(in Vector4 vector1, in Vector4 vector2, float amount, out Vector4 result)
	{
	    result.X = vector1.X + (vector2.X - vector1.X) * amount;
	    result.Y = vector1.Y + (vector2.Y - vector1.Y) * amount;
	    result.Z = vector1.Z + (vector2.Z - vector1.Z) * amount;
	...
	/// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
	/// <returns>The interpolated <see cref="Vector4"/>.</returns>
	public static Vector4 Hermite(Vector4 vector1, Vector4 tangent1, Vector4 vector2, Vector4 tangent2, float amount)
	{
	...
	/// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
	/// <param name="result">The interpolated <see cref="Vector4"/>.</param>
	public static void Hermite(in Vector4 vector1, in Vector4 tangent1, in Vector4 vector2, in Vector4 tangent2, float amount, out Vector4 result)
	{
	    var t2 = amount * amount;
	    var t3 = t2 * amount;
	...
	/// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
	/// <returns>The interpolated <see cref="Vector4"/>.</returns>
	public static Vector4 SmoothStep(Vector4 vector1, Vector4 vector2, float amount)
	{
		var amount;
	...
	/// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
	/// <param name="result">The interpolated <see cref="Vector4"/>.</param>
	public static void SmoothStep(in Vector4 vector1, in Vector4 vector2, float amount, out Vector4 result)
	{
		var amount;
	    amount = amount > 1 ? 1 : amount < 0 ? 0 : amount;
	    amount = amount * amount * (3.0f - 2.0f * amount);
	...
	/// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
	/// <returns>The interpolated <see cref="Vector4"/>.</returns>
	public static Vector4 CatmullRom(Vector4 vector1, Vector4 vector2, Vector4 vector3, Vector4 vector4, float amount)
	{
	    var t2 = amount * amount;
	    var t3 = t2 * amount;
	...
	/// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
	/// <param name="result">The interpolated <see cref="Vector4"/>.</param>
	public static void CatmullRom(in Vector4 vector1, in Vector4 vector2, in Vector4 vector3, in Vector4 vector4, float amount, out Vector4 result)
	{
	    var t2 = amount * amount;
	    var t3 = t2 * amount;
	...
	public static void Distance(in Vector4 vector1, in Vector4 vector2, out float result)
	{
	    var dx = vector2.X - vector1.X;
	    var dy = vector2.Y - vector1.Y;
	    var dz = vector2.Z - vector1.Z;
	...
	public static void DistanceSquared(in Vector4 vector1, in Vector4 vector2, out float result)
	{
	    var dx = vector2.X - vector1.X;
	    var dy = vector2.Y - vector1.Y;
	    var dz = vector2.Z - vector1.Z;
	...
	public static void Barycentric(in Vector4 v1, in Vector4 v2, in Vector4 v3, float b2, float b3, out Vector4 result)
	{
	    var b1 = (1 - b2 - b3);
