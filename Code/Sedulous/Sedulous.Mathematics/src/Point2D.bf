...
/// </summary>
struct Point2D : IEquatable<Point2D>, IInterpolatable<Point2D>, IEquatable, IHashable
{
    /// <summary>
    ...
    /// <param name="multiplier">The multiplier to apply to the size.</param>
    /// <returns>A <see cref="Point2D"/> which is the result of the muliplication.</returns>
    public static Point2D operator *(Point2D point, float multiplier)
    {
        Point2D result;
    ...
    /// <param name="divisor">The divisor to apply to the size.</param>
    /// <returns>A <see cref="Point2D"/> which is the result of the muliplication.</returns>
    public static Point2D operator /(Point2D point, float divisor)
    {
        Point2D result;
    ...
    public static explicit operator Size2F(Point2D point)
    {
        ...
        result.Width = (float)point.X;
        result.Height = (float)point.Y;
    ...
    public static void Transform(in Point2D point, in Quaternion quaternion, out Point2D result)
    {
        var x2 = quaternion.X + quaternion.X;
        var y2 = quaternion.Y + quaternion.Y;
        var z2 = quaternion.Z + quaternion.Z;
    ...
    /// <param name="matrix">The matrix by which to transform the point.</param>
    /// <param name="result">The transformed <see cref="Point2D"/>.</param>
    public static void Transform(in Point2D point, in Matrix matrix, out Point2D result)
    {
        Point2D temp;
    ...
    public Point2D Interpolate(Point2D target, float t)
    {
        Point2D result;
