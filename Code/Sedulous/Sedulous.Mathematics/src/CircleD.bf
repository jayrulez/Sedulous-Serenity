...
/// </summary>
struct CircleD : IEquatable<CircleD>, IInterpolatable<CircleD>, IEquatable, IHashable
{
    /// <summary>
    ...
    public this(double x, double y, double radius)
    {
        this.X = x;
        this.Y = y;
        this.Radius = radius;
    ...
    /// <param name="radius">The circle's radius.</param>
    public this(Point2D position, double radius)
    ...
    public static explicit operator CircleF(CircleD circle)
    {
        ...
        result.X = (float)circle.X;
        result.Y = (float)circle.Y;
        result.Radius = (float)circle.Radius;
    ...
    public CircleD Interpolate(CircleD target, float t)
    {
        CircleD result;
